...
import { WalletMiddlewareServer } from '../../lib/ethers/zksync/server'
...
console.log(
  `${packageData.name} v${packageData.version} (zksync-ethers: ${packageData.dependencies['zksync-ethers']})`
)
console.log()

const destinationProvider = new Provider(
  providerUrl,
  network
)
